...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppApplicationsExpensesExpensesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function ExpensesService() {
        ...
        this.expensesBoards = [];
        this.updatedExpensesBoards = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.updatedCurrentBoard = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
      }

      _createClass(ExpensesService, [{
        key: "putIntoExpensesBoards",
        value: function putIntoExpensesBoards(board) {
          this.expensesBoards.push(board);
          this.updatedExpensesBoards.next(_toConsumableArray(this.expensesBoards));
        }
      }, {
        key: "getFromExpensesBoards",
        value: function getFromExpensesBoards() {
          return _toConsumableArray(this.expensesBoards);
        }
      }, {
        key: "getUpdatedExpensesBoards",
        value: function getUpdatedExpensesBoards() {
          return this.updatedExpensesBoards.asObservable();
        }
      }, {
        key: "deleteFromExpensesBoards",
        value: function deleteFromExpensesBoards(itemIndex) {
        ...
        key: "putCurrentBoard",
        value: function putCurrentBoard(data) {
          this.currentBoard = data;
          this.updatedCurrentBoard.next(Object.assign({}, this.currentBoard));
        }
      }, {
        key: "getCurrentBoard",
        ...
        key: "getUpdatedCurrentBoard",
        value: function getUpdatedCurrentBoard() {
          return this.updatedCurrentBoard.asObservable();
        }
      }, {
        key: "deleteCurrentBoard",
        value: function deleteCurrentBoard() {
          this.currentBoard = {
            boardName: '',
            boardExpenses: [],
            boardSubtitle: '',
    ...
    ExpensesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], ExpensesService);
    /***/
  }
}]);
